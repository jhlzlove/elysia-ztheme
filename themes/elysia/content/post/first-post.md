...
{{ video(bilibili="BV1GP4y1d729", max_width="100%", caption="演示视频") }}

{{ video(src="https://github.com/volantis-x/volantis-docs/releases/download/assets/IMG_0341.mov") }}
...
这是我的第一篇使用 Stellar 主题的 Zola 博客文章。
...
{{ link(href="/about", title="关于本站", icon="/avatar.png") }}

写法：

```md
{{/* link(href="/about", title="关于本站") */}}
```
...
````
```markdown
// 默认 left，可不填参数，支持 left、center、right
{%/* tabs(align="center") */%}
<!-- tab node -->
使用 node 安装
...
{{ image(src="/avatar.png",width="300px") }}

写法：

```markdown
{{/* image(src="/avatar.png", width="120px") */}}
```
