...
[extra]
pinned = true
cover= "/images/default_cover1.jpg"
[taxonomies]
categories = ["主题"]
tags = ["zola", "博客", "主题"]
+++
...
> [!IMPORTANT]
> 只对简单的中文符号有修复效果，日常使用请养成中英文之间添加空格的好习惯~
...
```markdown
// width caption 可选参数，width 默认 100%
{{/* video(bilibili="BV1n8Q7B7Ekz", caption="演示视频") */}}
...
```markdown
{{/* image(src="/avatar.jpg", width="120px") */}}
```
